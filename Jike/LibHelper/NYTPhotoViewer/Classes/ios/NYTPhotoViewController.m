...
@property (nonatomic) UITapGestureRecognizer *singleTapGestrureRecognizer;
@end
...
- (void)viewDidLoad {
    ...
    [self.view addGestureRecognizer:self.singleTapGestrureRecognizer];
}
...
- (void)setupGestureRecognizers {
    ...
    self.singleTapGestrureRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(singelTapWithGestureRecognizer:)];
    self.singleTapGestrureRecognizer.numberOfTapsRequired = 1;
    [self.singleTapGestrureRecognizer requireGestureRecognizerToFail:self.doubleTapGestureRecognizer];
}
...
-(void)singelTapWithGestureRecognizer:(UITapGestureRecognizer *)recognizer
{
    [self.delegate photoViewController:self tapToWithGestureRecognizer:recognizer];
}
