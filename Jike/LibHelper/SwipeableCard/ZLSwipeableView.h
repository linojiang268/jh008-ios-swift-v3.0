...
//show card number in screen
@property (nonatomic) NSInteger prefetchedViewsNumber;
/// The currently displayed top most view.
@property (nonatomic, readonly) UIView *topSwipeableView;

//记录滑动卡片的张数
@property (nonatomic) NSInteger userHasSwipeCardCount;
...
//load up to 3 swipeable views with animation
