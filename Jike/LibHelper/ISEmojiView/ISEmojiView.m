...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        for (int i = 0; i < [self.emojis count] + numOfPage - 1; i++) {
            ...
            NSInteger emojiWidth = CGRectGetWidth(frame) / colNum;
            NSInteger emojiHeight = CGRectGetHeight(frame) / rowNum;
            ...
            if (row == (rowNum - 1) && column == (colNum - 1)) {
                ...
                deleteButton.frame = CGRectMake(currentRect.origin.x, currentRect.origin.y, currentRect.size.width+8.0, currentRect.size.height);
        ...
        self.pageControl.frame = CGRectMake(CGRectGetMidX(frame) - (pageControlSize.width / 2),
                                            CGRectGetHeight(frame) - pageControlSize.height + 10,
